...
public class exercício6 {
	...
	public static void main(String[] args) {
		...
		// quantidade de alunos de cada sala de aula
		...
		// média de cada aluno de cada sala
			...
			for(int i = 0; i < salas.length; i++) {
				...
				double media = 0; 
				double acima = 0; // alunos acima da media
				double x; //porcentagem
				
				    // FOR para pegar as notas de cada aluno de cada sala
